  ...
  return (
    <section className={`card create-post ${isLocked ? 'is-locked' : ''}`}>
      <div className="create-post-header">
        <button className="icon-button" type="button" aria-label="Close" disabled>
          <span className="icon-dot">x</span>
        </button>
        <h2>Create Post</h2>
        <span className="muted">{remaining} chars</span>
      </div>
      <textarea
      ...
      <div className="create-post-footer">
        ...
        <button className="button button-outline" type="button" disabled={isLocked}>
          Cancel
        </button>
      </div>
    </section>
