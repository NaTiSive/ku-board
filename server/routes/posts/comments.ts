// server/routes/posts/comments.ts
// ─────────────────────────────────────────────────────────────────────────────
...
//
// [เปลี่ยนแปลง] เพิ่ม notifyComment() หลัง insert comment สำเร็จ
//               แจ้งทั้งเจ้าของโพสและคนที่เคย interact ไว้
//               Guest comment → ไม่ trigger notification
// ─────────────────────────────────────────────────────────────────────────────
...
import { notifyComment } from "../notifications/triggers"; // [ใหม่]
